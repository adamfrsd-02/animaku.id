...
export default function Home() {
  ...
  return (
    <div className="bg-gradient-to-br from-[#233458] to-[#111827] min-h-screen">
      ...
      <center>
        {/* hero section */}
        <main className="flex flex-row justify-between px-24 h-[calc(100vh-100px)]">
          <div className="flex flex-col w-1/2  my-auto gap-2">
            <h1 className="text-white font-regular text-4xl text-left leading-normal">
              Find Your Favorites <br />
              Anime Information Here !
            </h1>
            <p className="text-left text-gray-400 leading-loose">
              In this website you can find your favorite anime information such
              as the synopsis, the cast, the genre, and the rating. You can also
              find the anime schedule and the latest anime news. So, feel free
              to find your favorite anime information here !
            </p>
            {/* input bar with search icon on the left */}
            <form onSubmit={onSearchSubmit}>
              <label class="relative text-gray-400 focus-within:text-gray-600 block mt-10">
                ...
                <input
                  ...
                  name="search"
                  class="form-input border border-gray-400 rounded-xl py-3 px-4 bg-transparent placeholder-gray-400 text-white appearance-none w-full block pl-14 focus:outline-none"
                />
              </label>
            </form>
          ...
          <div className="flex flex-col w-1/2 my-auto mx-auto px-16">
            <center>
              <img src="assets/img/thumbnail.png" className="ml-16" alt="" />
            </center>
          </div>
        </main>
        {/* end of hero section */}
